 ...
 * @author User
 */
public class SHistoryPanel extends javax.swing.JPanel {
    private DefaultTableModel model = new DefaultTableModel();
    private String[] columnName = {"Counselor Name", "StartTime", "EndTime","Specialism", "Status"};
    private OStudent user;
    /**
     * Creates new form ARecomPanel
     */
    public SHistoryPanel(OStudent user) {
        this.user = user;
        initComponents();
        model.setColumnIdentifiers(columnName);
        for(String line: Functions.readFile("appointment.txt")){
            String[] p = line.split(",");
            if(!p[7].equals("Done")){continue;}
            if(p[2].equals(user.getId())){
                String[] data = {Functions.filterID(p[1], "userData.txt").split(",")[1],p[3],p[4],p[8],p[7]};
                model.addRow(data);
            }
        }
    }
