...
import assignment.Objects.OAppointment;
...
public class SAppointPanel extends javax.swing.JPanel {
    ...
    private final Calendar today = (Calendar) startDay.clone();
     ...
     */
    public SAppointPanel(Main frame, OStudent user) {
        this.frame = frame;
        this.user = user;
        initComponents();
        ...
        for(String line : Functions.readFile("appointment.txt")){
            if(!line.isEmpty()){
                if(!line.split(",")[2].equals(user.getId())){continue;}
                if(Functions.StringtoDateTime(line.split(",")[3]).before(today)){continue;}
    ...
    private void initComponents() {
        ...
        Left.setPreferredSize(new java.awt.Dimension(270, 0));
                ...
                .addGroup(LeftLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(LeftLayout.createSequentialGroup()
                        .addGroup(LeftLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(LeftLayout.createSequentialGroup()
                                .addComponent(DayList, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(MonthList, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void createButActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createButActionPerformed
        ...
        String sId = Functions.filterData(Functions.readFile("userData.txt"), user.getName(), 1).get(0).split(",")[0];
    ...
    private void updateButActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButActionPerformed
        if(row==-1){
            ...
            if(JOptionPane.showConfirmDialog(frame, "Are you sure you want to make changes?")==0){
                ...
                updateApp.setStudentId(user.getId());
