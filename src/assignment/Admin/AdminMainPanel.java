...
import assignment.LoginPanel;
import assignment.Main;
import assignment.Objects.OAdmin;
import assignment.UpdatePanel;
...
public class AdminMainPanel extends javax.swing.JPanel {
     ...
     */
    public AdminMainPanel(Main frame, OAdmin user) {
        this.frame = frame;
        this.user = user;
    ...
    private void initComponents() {
        ...
        destruct = new javax.swing.JButton();
        ...
        StaffBut.setFont(new java.awt.Font("Bell MT", 1, 18)); // NOI18N
        StaffBut.setText("Manage staff roster and schedules");
        StaffBut.setAlignmentY(0.0F);
        StaffBut.setBorder(null);
        ...
        AppBut.setText("Monitor appointment statistics");
        ...
        destruct.setBackground(new java.awt.Color(0, 153, 51));
        destruct.setText("Self-destruct");
        destruct.addActionListener(this::destructActionPerformed);
        ...
        TaskBarLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, TaskBarLayout.createSequentialGroup()
                ...
                .addComponent(destruct, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        TaskBarLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, TaskBarLayout.createSequentialGroup()
                ...
                .addGroup(TaskBarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(destruct, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void AccButActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AccButActionPerformed
        butHighlight(AccBut);
        accPanel = new AAccountPanel(frame);
    ...
    private void destructActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_destructActionPerformed
        if(JOptionPane.showConfirmDialog(frame, "Confirm deletion? This action cannot be undone!")==0){
            if(JOptionPane.showConfirmDialog(frame, "Are you sure?")==0){
                if(JOptionPane.showInputDialog(frame, "Please enter \"PROCEED\" to proceed deletion").equals("PROCEED")){
                    new File("appointment.txt").delete();
                    new File("note.txt").delete();
                    new File("cProfile.txt").delete();
                    new File("loginData.txt").delete();
                    new File("userData.txt").delete();
                    JOptionPane.showMessageDialog(frame, "Deleted every data!");
                    System.exit(0);
                }
            }
        }
        JOptionPane.showMessageDialog(frame, "Action was interrupted");
    }//GEN-LAST:event_destructActionPerformed
    ...
    private javax.swing.JButton destruct;
